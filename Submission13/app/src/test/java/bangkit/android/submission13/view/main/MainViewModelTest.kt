...
import bangkit.android.submission13.DataDummy
import bangkit.android.submission13.MainDispatcherRule
import bangkit.android.submission13.data.Repository
import bangkit.android.submission13.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val data: PagingData<ListStoryItem> = cStoryPagingSource.snapshot(dummyStory)
...
class cStoryPagingSource : PagingSource<Int, LiveData<List<ListStoryItem>>>() {
    companion object {
